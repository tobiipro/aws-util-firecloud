...
exports.getInstanceTypeToArch = exports._awsInstanceTypeToArch = undefined;
...
const _awsInstanceTypeToArch = exports._awsInstanceTypeToArch = {
  't1.micro': 'PV64',
  't2.nano': 'HVM64',
  't2.micro': 'HVM64',
  't2.small': 'HVM64',
...
let getInstanceTypeToArch = exports.getInstanceTypeToArch = function ({ instanceType }) {
  if (!_lodashFirecloud2.default.has(exports._awsInstanceTypeToArch, instanceType)) {
    throw new Error(`Unknown instance type ${instanceType}.`);
  }

  return exports._awsInstanceTypeToArch[instanceType];
};
