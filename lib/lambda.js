...
exports.getDeliveryStreamName = exports.getStreamName = exports.getTableName = exports.bootstrap = exports.getRequestInstance = exports.setupLogging = exports._getEnvCtx = exports.getEnvCtx = exports.getEnvCtxResolver = exports.mergeEnvCtx = exports.inspect = exports.asyncHandler = exports.awsLoggerRE = undefined;
  ...
  var _ref = (0, _bluebird.coroutine)(function* ({ _e, ctx }) {
    ...
    if (previousMemoryUsage) {
      ...
      exports.inspect.previousMemoryUsage = {
        rss: exports.inspect.process.memoryUsage.rss,
        heapUsed: exports.inspect.process.memoryUsage.heapUsed,
        uptime: exports.inspect.process.uptime
      };
    }
