...
exports.getDeliveryStreamName = exports.getStreamName = exports.getTableName = exports.getBucketName = exports.bootstrap = exports.getRequestInstance = exports.setupLogging = exports._getEnvCtx = exports.getEnvCtx = exports.getEnvCtxResolver = exports.mergeEnvCtx = exports.inspect = exports.asyncHandler = exports.awsLoggerRE = undefined;
...
let mergeEnvCtx = exports.mergeEnvCtx = (() => {
  var _ref2 = (0, _bluebird.coroutine)(function* ({ e, ctx, pkg }) {
  ...
  return function mergeEnvCtx(_x2) {
...
let getEnvCtx = exports.getEnvCtx = (() => {
  var _ref3 = (0, _bluebird.coroutine)(function* ({ ctx, tags = ['default'] }) {
  ...
  return function getEnvCtx(_x3) {
    return _ref3.apply(this, arguments);
  };
})();

let _getEnvCtx = exports._getEnvCtx = (() => {
  var _ref4 = (0, _bluebird.coroutine)(function* ({ ctx: { env }, tags }) {
    // eslint-disable-next-line fp/no-arguments
    let cacheKey = exports.getEnvCtxResolver(...arguments);
    ...
    yield _lodashFirecloud2.default.consoleLogTime('_getEnvCtx: Fetching env ctx...', (0, _bluebird.coroutine)(function* () {
      let result = yield s3.getObject({
        ...
        IfMatch: _lodashFirecloud2.default.defaultTo(_getEnvCtx.oldCache[cacheKey], {}).etag
      }).promise();
  ...
  return function _getEnvCtx(_x4) {
    return _ref4.apply(this, arguments);
  };
})();
exports._getEnvCtx = _getEnvCtx = _lodashFirecloud2.default.memoize(exports._getEnvCtx, exports.getEnvCtxResolver);
exports._getEnvCtx.oldCache = new _lodashFirecloud2.default.memoize.Cache();
...
let setupLogging = exports.setupLogging = function ({ e, ctx }) {
  ...
  _awsSdk2.default.config.logger = {
    ...
    log: function (message) {
      ...
      try {
        let paramsWithoutArrayLength = _lodashFirecloud2.default.replace(params, /,\s+\[length\]:\s+\d+(\s+\])/g, '$1');
...
let bootstrap = exports.bootstrap = function (fn, { pkg }) {
  return exports.asyncHandler((() => {
    var _ref6 = (0, _bluebird.coroutine)(function* (e, ctx, next) {
...
let getBucketName = exports.getBucketName = function ({
  env,
  pkg,
  region
}) {
  let name = (0, _s.getEnvBucketName)({
    env,
...
let getTableName = exports.getTableName = function ({
  pkg,
  suffix = '',
  env
}) {
...
let getStreamName = exports.getStreamName = exports.getTableName;

let getDeliveryStreamName = exports.getDeliveryStreamName = exports.getTableName;
