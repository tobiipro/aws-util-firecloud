...
let getPolicyStatement = exports.getPolicyStatement = (() => {
  var _ref4 = (0, _bluebird.coroutine)(function* ({ _env } = {}) {
    let Statement = [];
  ...
  return function getPolicyStatement() {
    return _ref4.apply(this, arguments);
  };
})();

let getPolicy = exports.getPolicy = (() => {
  var _ref5 = (0, _bluebird.coroutine)(function* ({ env }) {
    let Policy = {
  ...
  return function getPolicy(_x4) {
    return _ref5.apply(this, arguments);
  };
})();

let getRole = exports.getRole = (() => {
  var _ref6 = (0, _bluebird.coroutine)(function* ({ env }) {
    let Role = {
      Type: 'AWS::IAM::Role',
      Properties: {
