"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = exports.executeQuery = exports.queryResultIsShowResult = exports.queryResultToText = exports.queryResultToObjectsArray = exports.pollQueryCompletedState = exports.getOutputBucketName = exports.getDatabaseName = void 0;var _lodashFirecloud = _interopRequireDefault(require("lodash-firecloud"));
...
let getOutputBucketName = function ({
  region,
  env })
{
  region = _lodashFirecloud.default.defaultTo(region, (0, _region.get)({ env }));
...
let pollQueryCompletedState = async function (args) {
  _lodashFirecloud.default.defaults(args, {
    pollingDelay: 1000 });
  ...
  if (state === 'RUNNING' || state === 'QUEUED' || state === 'SUBMITTED') {
    ...
    return await (async createError => {try {return await pollQueryCompletedState(args);} catch (_awaitTraceErr3) {let err = createError();_awaitTraceErr3.stack += "\n...\n" + err.stack;throw _awaitTraceErr3;}})(() => new Error());
  }
...
let queryResultToText = function (queryResult) {
  let rows = queryResult.ResultSet.Rows;
  let lines = _lodashFirecloud.default.map(rows, 'Data[0].VarCharValue');
  ...
  initPollingDelay = pollingDelay })
{
  ...
  return rows;
};exports.executeQuery = executeQuery;var _default =
