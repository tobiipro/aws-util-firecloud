...
exports.executeQuery = exports.queryResultIsText = exports.queryResultToText = exports.queryResultToObjectsArray = exports.pollQueryCompletedState = exports.getOutputBucketName = exports.getDatabaseName = undefined;
...
let queryResultIsText = exports.queryResultIsText = function (queryResult) {
  let columnInfo = queryResult.ResultSet.ResultSetMetadata.ColumnInfo;
  if (columnInfo.length === 1 && columnInfo[0].Name === 'createtab_stmt' && columnInfo[0].Label === 'createtab_stmt' && columnInfo[0].Type === 'string') {
    return true;
  }

  if (columnInfo.length === 1 && columnInfo[0].Name === 'tab_name' && columnInfo[0].Label === 'tab_name' && columnInfo[0].Type === 'string') {
    return true;
  }
...
let executeQuery = exports.executeQuery = (() => {
  var _ref2 = (0, _bluebird.coroutine)(function* ({
    ...
    if (exports.queryResultIsText(queryResult)) {
