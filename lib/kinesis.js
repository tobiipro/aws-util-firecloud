  ...
  records })
{
  ...
  _lodashFirecloud.default.forEach(records, function (record) {
    ...
    if (dataByteSize > exports.limits.recordByteSize) {
      ...
      ctx.log.error({ _babelSrc: { file: typeof __filename === "undefined" ? "src/kinesis.js" : __filename, babelFile: "src/kinesis.js", line: 54, column: 7 } }, `Skipping record larger than ${exports.limits.recordByteSize / 1024} KB: \
