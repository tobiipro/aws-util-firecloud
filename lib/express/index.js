  ...
  pkg })
{
  return (0, _lambda.bootstrap)(async function (e, ctx) {
    let app;
    await (async createError => {try {return await ctx.log.trackTime({ _babelSrc: { file: typeof __filename === "undefined" ? "src/express/index.js" : __filename, babelFile: "src/express/index.js", line: 111, column: 11 } },
    ...
    let result;
    ctx.log.info({ _babelSrc: { file: typeof __filename === "undefined" ? "src/express/index.js" : __filename, babelFile: "src/express/index.js", line: 119, column: 5 } }, 'Creating HTTP server (handling request)...');
    await (async createError => {try {return await ctx.log.trackTime({ _babelSrc: { file: typeof __filename === "undefined" ? "src/express/index.js" : __filename, babelFile: "src/express/index.js", line: 120, column: 11 } },
