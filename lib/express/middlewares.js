...
let _sendResponseError = function (res, err) {
  ...
  body.instance = (0, _lambda.getRequestInstance)(res.req);
...
let handleResponseError = function () {
  ...
  return function (err, _req, res, _next) {
    ...
    ctx.log.error({ _babelSrc: { file: typeof __filename === "undefined" ? "src/express/middlewares.js" : __filename, babelFile: "src/express/middlewares.js", line: 62, column: 5 } }, { err });

    if (res.headersSent) {
      ctx.log.error({ _babelSrc: { file: typeof __filename === "undefined" ? "src/express/middlewares.js" : __filename, babelFile: "src/express/middlewares.js", line: 65, column: 7 } }, "Headers already sent. Can't send error.");
    ...
    if (err instanceof _resError.default) {
      ctx.log.error({ _babelSrc: { file: typeof __filename === "undefined" ? "src/express/middlewares.js" : __filename, babelFile: "src/express/middlewares.js", line: 72, column: 7 } }, `Responding with ${err.code} ${err.message}...`);
    ...
    if (res.ctx.log._canTrace) {
      ...
      ctx.log.info({ _babelSrc: { file: typeof __filename === "undefined" ? "src/express/middlewares.js" : __filename, babelFile: "src/express/middlewares.js", line: 83, column: 7 } }, 'Responding with trace...');
