...
let ResponseError = function (status, extensions = {}) {
  this.code = status;
  this.message = _http.default.STATUS_CODES[status];
...
exports.ResponseError.prototype = new Error();var _default = exports.ResponseError;exports.default = _default;
