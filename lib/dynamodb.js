...
exports.dcPut = exports.dcScan = exports.scanWithBackticks = exports.getDefaultTotalSegments = undefined;
...
let dcPut = exports.dcPut = (() => {
  var _ref5 = (0, _bluebird.coroutine)(function* (args) {
    ...
    args.Item = _lodashFirecloud2.default.mapValuesDeep(_lodashFirecloud2.default.pickBy)(args.Item, function (value) {
