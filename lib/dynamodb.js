"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = exports.dcPut = exports.dcScan = exports.scanWithBackticks = exports.getDefaultTotalSegments = void 0;var _lodashFirecloud = _interopRequireDefault(require("lodash-firecloud"));
...
let scanWithBackticks = function (args) {
...
let dcPut = async function (args) {
  let dc = new _awsSdk.default.DynamoDB.DocumentClient();

  args.Item = _lodashFirecloud.default.mapValuesDeep(_lodashFirecloud.default.pickBy)(args.Item, function (value) {
...
};exports.dcPut = dcPut;var _default =
